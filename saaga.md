...
author if anything is not clear. Taxonomy outputs are described in the **Summarise taxonomic assignments for contamination assessments [taxonomy=T]** section. Detailed documentation will be available through the [Taxolotl](https://github.com/slimsuite/taxolotl) program.
